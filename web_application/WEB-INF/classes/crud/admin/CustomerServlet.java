	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		//from customers.jsp
		else if (action.equals("add_customer"))
			{
				...
				String total_sales_v = request.getParameter("total_sales");
				String notes_v = request.getParameter("notes");
				
				//instantiate new customer object with associated object variable (user)
				Customer user = new Customer(id_v, firstName_v, lastName_v, street_v, city_v, state_v, zip_v, phone_v, email_v, balance_v, total_sales_v, notes_v);

				//call data input validation method: *Must* agree in TON: type, order, number!
				if(!isValidInput(firstName_v, lastName_v, street_v, city_v, state_v, zip_v, phone_v, email_v, balance_v, total_sales_v, notes_v))
					{
